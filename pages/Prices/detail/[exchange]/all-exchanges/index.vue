                                    ...
                                    <div class="w-full md:w-[310px]">
                                        <div class="flex items-center gap-2 justify-start mb-4">
                                            <div class="w-[132px]">
                                                ...
                                                <div class="text-[#6B6C6F] font-normal text-xs">Price per BTC</div>
                                            </div>
                                            <div class="w-auto">
                                                <div class="text-[#23A638] font-normal text-base">+7.34%</div>
                                                <div class="text-[#6B6C6F] font-normal text-xs">The best average price</div>
                                            </div>
                                        </div>
